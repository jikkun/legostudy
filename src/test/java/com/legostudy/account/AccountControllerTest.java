...
class AccountControllerTest {
    ...
    void checkEmailToken_with_wrong_input() throws Exception{
        mockMvc.perform(get("/check-email-token")
                .param("token", "dlwdwkqj")
                .param("email", "dwlqwdq@email.com"))
    ...
    void checkEmailToken() throws Exception{
        ...
        mockMvc.perform(get("/check-email-token")
                ...
                .andExpect(view().name("account/checked-email"))
                .andExpect(authenticated().withAuthenticationName("nickname"));
    }
    ...
    void signUpSubmit_with_wrong_input() throws Exception {
        mockMvc.perform(post("/sign-up")
                ...
                .param("email","errEmail...")
                .param("password","errpass")
                .with(csrf()))
                .andExpect(status().isOk())
                .andExpect(view().name("account/sign-up"))
                .andExpect(unauthenticated());
    ...
    void signUpSubmit_with_correct_input() throws Exception {
        ...
        assertTrue(accountRepository.existsByEmail("abcd@email.com"));
